...
class TestNetworkManager:
    ...
    @pytest.mark.asyncio
    async def test_get_right_team_score_with_missing_feed(self):
    ...
    @pytest.mark.asyncio
    async def test_get_left_team_score_with_string_number(self):
